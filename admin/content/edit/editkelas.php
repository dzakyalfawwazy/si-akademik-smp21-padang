  ...
  $dkel=mysqli_fetch_array(mysqli_query($con,"SELECT * from tbl_kelas"))
  ?>
        ...
        <div class="card card-primary">
          ...
          <div class="card-body">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="kodekelas" readonly name="kodekelas" value="<?= $dkel['kd_kelas'] ?>">
            </div>
            <div class="form-group">
